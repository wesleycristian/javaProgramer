...
public class PassagemPorValor {
	...
	public static void main(String[] args) {
		...
		System.out.println("Antes da chamada do método alterarValor "
				+ "o valor é " + valor);
		alterarValor(valor);
		System.out.println("Depois da chamada do método alterarValor "
				+ "o valor é " + valor);
		System.out.println();
	...
	static void alterarReferenciaObjeto(Pessoa p){
		...
		ana.idade = 18;
		ana.exibirDados();
		p = ana; // tentativa de alterar o valor de p
	}
