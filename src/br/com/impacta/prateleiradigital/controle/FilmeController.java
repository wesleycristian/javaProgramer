...
import br.com.impacta.prateleiradigital.negocio.FilmesUtil;
...
public class FilmeController {
	 ...
	 */
	public ArrayList<Filme> consultarFilme(String tituloParcial, String genero, int anoInicial, int anoFinal) throws Exception{
	
		ArrayList<Filme> filmes = filmeDAO.consultar(tituloParcial,genero,anoInicial,anoFinal);
		
		return filmes;
	}
	public Filme consultarFilme(String titulo, int anoInicial, int anoFinal) throws Exception{

        Filme filme = filmeDAO.consultar(titulo,anoInicial,anoFinal);

        return filme;
    }
	public void alterarFilme(Filme filme2) throws Exception 
	{
		filmeDAO.alterarFilme(filme2);		
	}
	/**
	...
	public Filme remover(String text, String text2, int parseInt, int parseInt2) {
