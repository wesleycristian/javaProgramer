package br.com.impacta.prateleiradigital.apresentacao;
	...
	public class FilmeControler {
		...
		public void criarFilme(String titulo, String diretores, double nota, int duracao, int ano, String generos, int numVotos, String url) throws Exception{
			Filme filme  = extracted(titulo, diretores, nota, duracao, ano, generos, numVotos, url);
			filmeDAO.adicionar(filme);
		}

		private Filme extracted(String titulo, String diretores, double nota, int duracao, int ano, String generos,
				int numVotos, String url) {
			return new Filme(titulo, diretores, nota, duracao, ano, generos, numVotos, url);
		}
